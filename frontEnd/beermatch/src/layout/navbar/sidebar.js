...
const style = {
  ...
  link:"text-xl font-thin my-4 ml-2 text-yellow-300 hover:font-semibold "
};

export default function Sidebar() {

  return (
    <aside className="lg:visible invisible bg-PurpleNavy shadow-md h-full absolute w-60 z-40">
      <div className="mt-5">
        <img
