...
public class ReviewRequest {
    @ApiModelProperty(notes = "attentionRate in {1, ... , 5}", example = "3", required = true)
    ...
    @ApiModelProperty(notes = "priceRate in {1, ... , 5}", example = "5", required = true)
    ...
    @ApiModelProperty(notes = "qualityRate in {1, ... , 5}", example = "4", required = true)
    ...
    @ApiModelProperty(notes = "placeRate in {1, ... , 5}", example = "2", required = true)
    ...
    @ApiModelProperty(notes = "Text of the review", example = "First review lol", required = true)
