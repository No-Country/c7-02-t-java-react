package com.c702t.Cerveza.utils;
...
public class MultiPartFileClassUtils implements MultipartFile {
    ...
    public MultiPartFileClassUtils (String header,String contents){
